...
const ExperienceContainer = () => {
  const experiences = [
    {
      ...
      accomplishments: ["Optimized and streamlined  many work processes, by automating a number tasks on excel that were previously done manually, thus allowing the team’s time to be used more productively."
      ],
    },
    {
      ...
      accomplishments: ["Involved in the manufacturing of magnetic resonance imaging devices.", "Plan the order of daily tasks to maximize efficiency.", "A number of work awards for excellence, attention to detail and innovation, such as the automation of the measurement device software by using macro functions to navigate to the most commonly taken measurements making human errors less likely as well as improving  the user friendliness of the task."
  ...
  const experienceComponents = experiences.map((experienceObj, index)=> {
    return (
        <ExperienceComponent experienceObj={experienceObj} key={index}/>
    )
})
